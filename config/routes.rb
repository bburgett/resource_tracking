ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :mtef, :active_scaffold => true
  map.resources :nasa, :active_scaffold => true
  map.resources :nsp, :active_scaffold => true
  map.resources :nha, :active_scaffold => true
